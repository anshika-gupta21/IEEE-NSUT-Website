...
function Contact() {
  return (
    <section className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-cyan-gradient-2 rounded-[20px] box-shadow`}>
  ...
  />
      ...
      <div className="right_contact">
        <Lottie animationData={canime} loop={1} className="c_anime" />;
      </div>
    </div>
    </section>
  );

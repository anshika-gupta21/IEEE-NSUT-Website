    ...
    <div className='EventPage' id='events'>
      ...
      <div className='card-container'>
        <div className='card'>
          ...
          >
            <a
              href='https://www.instagram.com/p/CjM7Et2uEea/'
              style={buttonstyle1}
            >
              Explore Now
            </a>
        ...
        <div className='card'>
          ...
          <div className='card-content'>
            ...
            <div className='description'>An ideathon under project Inspire</div>
          </div>
          ...
          >
            <a
              href='https://docs.google.com/forms/d/e/1FAIpQLScG4TdIlJONHAQ0OVAnuDb0Y9wHpibsXadd9BXd6boaQGhx_w/viewform'
              style={buttonstyle2}
            >
              {" "}
              Explore Now
